...
#define ACTIONSHEET_WHITEGROUNDCOLOR             [UIColor colorWithRed:255/255.00f green:255/255.00f blue:255/255.00f alpha:0.6]
...
//居中视图参数值
//#define MIDDLESHAREBUTTON_WIDTH                       60
//#define MIDDLESHAREBUTTON_HEIGHT                      60
//#define MIDDLESHAREBUTTON_INTERVAL_WIDTH              35
//#define MIDDLESHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width - SHAREBUTTON_WIDTH * 3) / 4
...
#define BUTTON_WIDTH                            [UIScreen mainScreen].bounds.size.width * 0.75
...
- (UIButton *)creatCancelButtonWith:(NSString *)cancelButtonTitle activityName:(NSString *)activityName
{
    ...
    if (![activityName isEqualToString:@"false"] && activityName != nil)
    {
...
-(void)goToPointStore
{
    [self.delegate LXgoToPointStoreAction];
}
