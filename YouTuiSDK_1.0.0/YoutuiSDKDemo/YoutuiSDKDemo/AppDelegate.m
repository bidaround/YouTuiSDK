...
@interface AppDelegate ()<SinaWbDelegate> //新浪微博代理
{
    YouTuiSDK * YTSdk;
}
@end
...
-(BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    else if ([UrlStr hasPrefix:@"wb"])
    {
        ...
        {
            NSLog(@"新浪微博客户端回调");
            return [YouTuiSDK SinaWbhandleOpenURL:url delegate:self];
        }
        else
        {
            NSLog(@"腾讯微博回调");
    ...
    {
        NSLog(@"QQ回调");
        return [YouTuiSDK QQhandleOpenURL:url delegate:_ViewDelegate];
    }
