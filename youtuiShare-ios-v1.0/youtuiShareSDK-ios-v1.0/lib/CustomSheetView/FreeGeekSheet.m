...
#define ShareButtonWidth 55                                           //分享按钮宽度
#define ShareButtonHeight 55                                          //分享按钮高度
...
-(id)initWithTitle:(NSString *)Title Delegate:(id<FreeGeekDelegate>)delegate titleArray:(NSArray *)titleArray imageArray:(NSArray *)imageArray PointArray:(NSArray *)pointArray ShowRedDot:(BOOL)ShowRedDot ActivityName:(NSString *)activityName Middle:(BOOL)Middle
{
    ...
    for (int i = 0; i < [imageArray count]; i++)
    {
        ...
        if (i < 9)
        {
            Sharebutton.frame = CGRectMake(ButtonWidthInterval * (i % 3 + 1) + ShareButtonHeight * (i % 3), 10 + 91 * (i / 3), ShareButtonWidth, ShareButtonHeight);
            ShareTitleLabel.frame = CGRectMake(ButtonWidthInterval * (i % 3 + 1) + ShareButtonHeight * (i % 3), 70 + 91 * (i / 3), ShareButtonWidth, ShareTitleHeight);
            SharePointLabel.frame = CGRectMake(ButtonWidthInterval * (i % 3 + 1) + ShareButtonHeight * (i % 3), 80 + 91 * (i / 3), ShareButtonWidth, SharePointHeight);
        ...
        {
            int k = i - 9;
            Sharebutton.frame = CGRectMake(ButtonWidthInterval * (k % 3 + 1) + (imageArray.count / 10 - 1) * CurrentWidth + ShareButtonHeight * (k % 3), 10 + 91 * (k / 3), ShareButtonWidth, ShareButtonHeight);
            ShareTitleLabel.frame = CGRectMake(ButtonWidthInterval * (k % 3 + 1) + (imageArray.count / 10 - 1) * CurrentWidth + ShareButtonHeight * (k % 3), 70 + 91 * (k / 3), ShareButtonWidth, ShareTitleHeight);
            SharePointLabel.frame = CGRectMake(ButtonWidthInterval * (k % 3 + 1) + (imageArray.count / 10 - 1) * CurrentWidth + ShareButtonHeight * (k % 3), 80 + 91 * (k / 3), ShareButtonWidth, SharePointHeight);
    ...
    if (imageArray.count > 9)
    {
        page = [[UIPageControl alloc]initWithFrame:CGRectMake(0,_CustomScrollHeightInterval + _CustomScrollViewHeight,CurrentWidth, 10)];
    ...
    [UIView animateWithDuration:0.25 animations:^{
        SheetView.frame = CGRectMake(ScreenWidthInterval, (ScreenHeight - (CancelButton.frame.origin.y + CancelButtonHeight + 5)) / (Middle? 2 : 1), CurrentWidth, CancelButton.frame.origin.y + CancelButtonHeight + 5);
